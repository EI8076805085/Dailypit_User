package com.dailypit.dp.Model.Payment;
...
public class PackageCartResponse {
    ...
    public PackageCartResponse(String s_id,String qty, String s_name, String s_fees, String s_total,  String sub_catID) {
        this.s_id = s_id;
        this.qty = qty;
        this.s_name = s_name;
        this.s_fees = s_fees;
