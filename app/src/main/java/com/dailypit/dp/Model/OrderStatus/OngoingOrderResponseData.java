...
public class OngoingOrderResponseData {
    ...
    @SerializedName("c_code_verification")
    @Expose
    private String c_code_verification;
    ...
    public String getC_code_verification() {
        return c_code_verification;
    }

    public void setC_code_verification(String c_code_verification) {
        this.c_code_verification = c_code_verification;
    }
}
