...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ImageView img_back;
    LinearLayout signUP_linearLayout, txt_sendOTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onInstallReferrerSetupFinished(int responseCode) {
                switch (responseCode) {
                    ...
                    case InstallReferrerClient.InstallReferrerResponse.FEATURE_NOT_SUPPORTED:
                        ...
                        Toast.makeText(Login.this, "Feature not supported", Toast.LENGTH_SHORT).show();
                        break;
                    case InstallReferrerClient.InstallReferrerResponse.SERVICE_UNAVAILABLE:
                        Toast.makeText(Login.this, "Fail to establish connection", Toast.LENGTH_SHORT).show();
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Log.d("data", email + socialname + photo);
            ...
            public void onError(FacebookException exception) {
                // App code
                Toast.makeText(Login.this, "Somthing went wronge" + exception, Toast.LENGTH_SHORT).show();
            }
        });
